...
class GeoJSONToolsTest {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONString_shouldConvertGMLPointCorrectly() {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONString_shouldConvertGMLPolygonCorrectly() {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONString_shouldConvertMODSPointCorrectly() {
        {
            // 2D
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONString_shouldConvertDegMinSecPolygonCorrectly() {
        Assertions.assertTrue(GeoJSONTools.convertCoordinatesToGeoJSONString(
     ...
     */
    @Test
    void convertToWKT_shouldConvertPointsCorrectly() {
     ...
     */
    @Test
    void convertToWKT_shouldConvertPolygonsCorrectly() {
     ...
     */
    @Test
    void convertSexagesimalToDecimalPoints_shouldReturnSinglePointIfCoordinatesDuplicate() {
     ...
     */
    @Test
    void convertSexagesimalCoordinateToDecimal_shouldConvertCoordinateCorrectly() {
        Assertions.assertEquals(8.13222222, GeoJSONTools.convertSexagesimalCoordinateToDecimal("E0080756"), 1e-8);
    }

    @Test
    void convertSexagesimalCoordinateToDecimal_shouldConvertWesternCoordinateCorrectly() {
        Assertions.assertEquals(-8.13222222, GeoJSONTools.convertSexagesimalCoordinateToDecimal("W0080756"), 1e-8);
    }

    @Test
    void convertSexagesimalCoordinateToDecimal_shouldConvertSouthernCoordinateCorrectly() {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertGmlPointCorrectly() {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertGmlPoint4326Correctly() {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertGmlPolygonCorrectly() {
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertGmlPolygon4326Correctly() {
        FeatureCollection result = GeoJSONTools.convertCoordinatesToGeoJSONFeatureCollection(
                "51.8164115931853 9.86927764300289 51.8164107865348 9.86927733742467 51.81640215001 9.86936345721908 51.8162882108512 9.86933544862899 51.8163013830216 9.86921939760192 51.8164140490608 9.86924941164474 51.8164115931853 9.86927764300289",
                "gml:polygon:4326", " ");
        Assertions.assertNotNull(result);
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertModsPointCorrectly() {
        {
            // 2D
            FeatureCollection result =
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertSexagesimalPointCorrectly() {
        FeatureCollection result =
     ...
     */
    @Test
    void convertCoordinatesToGeoJSONFeatureCollection_shouldConvertSexagesimalPolygonCorrectly() {
     ...
     */
    @Test
    void getCoordinatesType_shouldDetectSexagesimalPointsCorrectly() {
     ...
     */
    @Test
    void getCoordinatesType_shouldDetectSexagesimalPolygonsCorrectly() {
